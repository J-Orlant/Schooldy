...
class ProfilePageOrtu extends StatefulWidget {
  const ProfilePageOrtu({Key? key}) : super(key: key);

  @override
  State<ProfilePageOrtu> createState() => _ProfilePageOrtuState();
}

class _ProfilePageOrtuState extends State<ProfilePageOrtu> {
  int _currentIndex = 0;
  @override
